...
public  class EmployeeEntity extends RealmObject  {
        ...
        public RealmList<LeadEntity> getLstLeads() {
            return lstLeads;
        }

        public void setLstLeads(RealmList<LeadEntity> lstLeads) {
